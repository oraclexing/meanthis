export const ENGLISH_MESSAGES = {
  ...
  bridge_step_choose_trust: "Choose trust",
  bridge_step_choose_trust_help: "Choose one-time approval or this browser session.",
  bridge_step_create_request: "Create request",
  bridge_step_create_request_help: "MeanThis copies a short-lived local request.",
  bridge_step_agent_approve: "Approve in your agent",
  bridge_step_agent_approve_help: "Paste the request into the agent on this device.",
  ...
  create_copy_request: "Create & copy request",
  copy_request_again: "Copy request again",
  cancel_request: "Cancel request",
  disconnect: "Disconnect",
  local_connection_request_aria: "Local agent connection request",
  bridge_trust_ask_help: "Ask for approval each time.",
  bridge_trust_session_help: "Keep approval until this browser session ends.",
  connection_details: "Connection details",
  local_bridge_security_detail: "Short-lived approval material stays on this device.",
  local_instance: "Local instance: {instanceId}",
  ready_to_connect: "Ready to connect. Start by choosing trust.",
  ...
  layout_relationship_optional: "Task note shortcuts (optional)",
  ...
  source_export_help: "Export the source-bound session for diagnostics or checkout-based tooling.",
  ...
  use_in_task_note: "Fill task note",
  ...
  request_copied: "Request copied. Paste it into the local agent to approve this connection.",
  request_ready: "Request ready. Copy the text below into the local agent.",
  ...
  waiting_approval: "Waiting for local approval. This request expires at {expiresAt}.",
  waiting_approval_bridge_unavailable: "Waiting for local approval. The bridge is temporarily unavailable.",
  connected_agent_unreachable: "Connected, but the local agent is not reachable. Restart its MCP process and reconnect if needed.",
  ...
  page_access_permission_reason: "For your privacy, the browser only lets MeanThis read a page after you select MeanThis from the toolbar on that page.",
